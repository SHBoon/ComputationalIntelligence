...
def run_once(mutation_rate, crossover_rate, population_size = 20, generations = 100):
...
mutation_values = np.linspace(0.01, 1.0, 20)
crossover_values = np.linspace(0.01, 1.0, 20)
